  ...
  $play.addEventListener("click", (e) => {
    ...
    timer = setInterval(() => {
      ...
      if (seconds < 10) {
        ...
        $secondsSelector.innerHTML = "0" + seconds;
